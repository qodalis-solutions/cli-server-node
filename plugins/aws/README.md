# @qodalis/cli-server-plugin-aws

AWS cloud resource management plugin for [Qodalis CLI Server (Node.js)](https://github.com/qodalis-solutions/cli-server-node). Provides commands for managing S3, EC2, Lambda, CloudWatch, SNS, SQS, IAM, DynamoDB, and ECS resources directly from the CLI.

## Install

```bash
npm install @qodalis/cli-server-plugin-aws
```
...
This plugin uses AWS SDK v3 for JavaScript:

- `@aws-sdk/client-s3`, `@aws-sdk/client-ec2`, `@aws-sdk/client-lambda`
- `@aws-sdk/client-cloudwatch`, `@aws-sdk/client-cloudwatch-logs`
- `@aws-sdk/client-sns`, `@aws-sdk/client-sqs`, `@aws-sdk/client-iam`
- `@aws-sdk/client-dynamodb`, `@aws-sdk/client-ecs`, `@aws-sdk/client-sts`
